...
public class AddAccountPane extends StackPane {
    ...
    public AddAccountPane() {
        ...
        cboType.getItems().setAll( Accounts.FACTORY_AUTHLIB_INJECTOR, Accounts.FACTORY_OFFLINE, Accounts.FACTORY_MOJANG);
        ...
        cboType.getSelectionModel().select(
                cboType.getItems().stream()
                        ...
                        .findFirst()
                        .orElse(Accounts.FACTORY_AUTHLIB_INJECTOR)); //DEFAULT FACTORY_AUTHLIB_INJECTOR
